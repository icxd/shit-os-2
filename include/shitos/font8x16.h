...
//
// Shared, not kernel-private: the framebuffer console draws with it and so
// does the window server's titlebar, and a second copy would drift. Plain C
// with no namespace so that both languages can include it.
//
...
static const u8 FONT_8X16[FONT_GLYPHS][FONT_HEIGHT] = {
